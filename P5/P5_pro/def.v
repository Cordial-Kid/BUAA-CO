...
`define CMP_BLZTAL 3'b001
`define CMP_BONALL 3'b010
...
`define NPC_BLZTAL 3'b100
`define NPC_BONALL 3'b101
...
`define BLZTAL 6'b100111
`define LBGET 6'b110101
`define BONALL 6'b011001
...
//define of DMOp
`define DMOPBASE 3'b000
`define DMOPLBGET 3'b001